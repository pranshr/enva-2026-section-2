const CarouselSlide = (props) => {
    ...
    return <div className="snap-center shrink-0 aspect-screens border-y border-[#d4af37]">
        <div className="bg-black/95 flex flex-col justify-around items-center h-full py-3 lg:py-2">
            ...
            <img src={image} className="h-[82%] w-[95%] rounded-md object-cover border border-[#d4af37]" />
